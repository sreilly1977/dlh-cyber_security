0-dns_resolver.py - A python function that resolves a domain name to its IPv4 address
1-dns_records.py - A python function that queries multiple DNS record types for a given domain
