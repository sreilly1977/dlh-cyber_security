...
$securityEvents = @(
    ...
    [PSCustomObject]@{
        ...
        attack_phase = "Credential Access, Discovery"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Credential Access, Lateral Movement"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Privilege Escalation, Defense Evasion"
    ...
    [PSCustomObject]@{
        ...
        attack_phase = "Execution, Defense Evasion"
        example_suspicious_pattern = "encoded powershell invocation, cmd.exe launched by word processor, system access tools, download utilities"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Persistence, Defense Evasion"
        example_suspicious_pattern = "Account created outside business hours, account with admin-like name but created by non-admin, account created on DC via script"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Defense Evasion, Impact"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "Critical"
        attack_phase = "Privilege Escalation, Persistence"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "Critical"
        attack_phase = "Defense Evasion, Cover Tracks"
...
$powerShellEvents = @(
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Execution, Defense Evasion"
        example_suspicious_pattern = "Encoded commands, web content execution, anti-virus disabling commands, exclusion path modifications"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "Critical"
        attack_phase = "Execution, Defense Evasion, Credential Access"
        example_suspicious_pattern = "credential dumping modules, token manipulation, anti-virus disabling commands, network listener setup, Windows API calls for system access"
...
$sysmonEvents = @(
    [PSCustomObject]@{
        ...
        triage_priority = "Critical"
        attack_phase = "Execution, Defense Evasion"
        example_suspicious_pattern = "word processor spawning command shell or powershell, download utilities, dll execution utilities, html application runners"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "C2, Lateral Movement, Exfiltration"
        example_suspicious_pattern = "shell connecting to non-Microsoft IP on port 443, system process initiating network connections, connections to known infrastructure, DNS queries to suspicious domains"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "Medium"
        attack_phase = "Defense Evasion, Privilege Escalation"
        example_suspicious_pattern = "unsigned library loaded into system process, library loaded from temp directory, vulnerable driver loaded, runtime library loaded by non-runtime process"
    ...
    [PSCustomObject]@{
        ...
        example_suspicious_pattern = "executable written to Startup folder, library dropped into System32, script created in Temp, encrypted file pattern indicating staging"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "Persistence, Defense Evasion"
        example_suspicious_pattern = "autorun keys set by non-installer process, compatibility shim insertion, anti-virus disabling registry value, debugger entry for image file execution"
    ...
    [PSCustomObject]@{
        ...
        triage_priority = "High"
        attack_phase = "C2, Discovery"
        example_suspicious_pattern = "high-entropy subdomains indicating tunneling, queries to newly registered domains, TXT queries with large response payloads, DNS to non-organizational DNS servers"
...
$report = [PSCustomObject]@{
    reference_metadata = [PSCustomObject]@{
        ...
        threat_context = "CISA advisory threat actor profile applied to MedDefense infrastructure"
