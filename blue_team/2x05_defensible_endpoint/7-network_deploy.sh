...
Write-Output "Windows Firewall aligned to MedDefense segmentation contract."
PS1EOF
...
# Generate comprehensive Suricata rules - fixed DNS tunneling detection
...
alert dns $HOME_NET any -> any any (msg:"MEDDEFENSE DNS activity detected - review for tunneling"; classtype:suspicious-activity; sid:9001020; rev:1;)
