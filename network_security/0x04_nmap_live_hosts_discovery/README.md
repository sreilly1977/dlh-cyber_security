0-arp_scan.sh - A bash script that scan a subnetwork to discover live host using ARP scan
...
5-tcp_ack_ping.sh - A  bash script that scan a subnetwork to discover live host using TCP ACK Ping scan
6-udp_ping_scan.sh  - A bash script that scan a subnetwork to discover live host using UDP Ping scan
